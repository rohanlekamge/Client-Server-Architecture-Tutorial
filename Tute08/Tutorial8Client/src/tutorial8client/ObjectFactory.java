 ...
 * generated in the tutorial8client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Multiply_QNAME = new QName("http://server/", "multiply");
    ...
    private final static QName _MultiplyResponse_QNAME = new QName("http://server/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://server/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://server/", "subtractResponse");
    private final static QName _Add_QNAME = new QName("http://server/", "add");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tutorial8client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "subtractResponse")
